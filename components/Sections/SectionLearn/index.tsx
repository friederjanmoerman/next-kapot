...
interface ISectionLearnProps {
  destinationScroll?: any
}

const SectionLearn = ({ destinationScroll }: ISectionLearnProps) => (
  <Section ref={destinationScroll} inverted>
    ...
    <Container container spacing={7}>
      <Grid item lg={6}>
        ...
        <Typography variant="h5">
          A personalised in person experience. You&apos;ll be privately thaught to inline skate by one of our teachers.
          We have one pair of adaptable size junior aggressive inline skates to try out for children. Ask beforehand,
          not always available! All ages and levels welcome. Access to our exclusive online inline skate community, a
          Whatsapp group.
        </Typography>
        <Button
